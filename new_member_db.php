...
if(file_exists("photos/".$f['name']))
 ...
 if($pass1==$pass2)
 {
	 ...
	 $q="insert into info(name,pass1,pass2,gender,date,contact,email,religion,aadhar,addA1,addA2,pinA,addB1,addB2,pinB,comment) values('$name','$pass1','$pass2','$gender','$date','$contact','$email','$religion','$aadhar','$addA1','$addA2','$pinA','$addB1','$addB2','$pinB','$comment')";
	 mysqli_query($con,$q);
	 mysqli_close($con);
 }
 else
